    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('alamat') is-invalid @enderror" name="alamat"
                            placeholder="Alamat Lengkap" required value="{{ old('alamat') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('no_ktp') is-invalid @enderror" name="no_ktp"
                            placeholder="Nomor KTP" required value="{{ old('no_ktp') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('no_hp') is-invalid @enderror" name="no_hp"
                            placeholder="Nomor HP" required value="{{ old('no_hp') }}">
                        <div class="input-group-append">
                            <div class="input-group-text">
                ...
                <p class="mb-1">
                    <a href="{{ route('login') }}">Sudah memiliki akun? Masuk di sini</a>
                </p>
                <p class="mb-0">
